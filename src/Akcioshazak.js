            ...
            <div className="card" key={property.id}>
              ...
              <div className="card-content">
                ...
                <p className="card-description-ar">
                  Régi Ár: {property.regiAr ? property.regiAr.toLocaleString() : 'N/A'} Ft
                </p>
                <p className="card-description">
                  Új Ár: {property.ar ? property.ar.toLocaleString() : 'N/A'} Ft
                </p>
      ...
      {selectedProperty && (
        <div className={`modal-show ${modalClosing ? "closing" : ""}`} onClick={closeModalOnOverlay}>
          <div className="modal-content">
            ...
            <p>Ár: {selectedProperty.ar ? selectedProperty.ar.toLocaleString() : 'N/A'} Ft</p>
