...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Akcioshazak>(entity =>
        {
            ...
            entity.ToTable("akcioshazaks");

            entity.HasIndex(e => e.Id, "Id");

            entity.HasIndex(e => e.IngatlanId, "IngatlanId");

            entity.Property(e => e.Id).HasColumnType("int(11)");
            entity.Property(e => e.AkciosAr).HasColumnType("bigint(20)");
            entity.Property(e => e.IngatlanId).HasColumnType("int(20)");

            entity.HasOne(d => d.Ingatlan).WithMany(p => p.Akcioshazaks)
                .HasForeignKey(d => d.IngatlanId)
                .HasConstraintName("akcioshazaks_ibfk_1");
        });
        ...
        modelBuilder.Entity<Ingatlanok>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnType("int(11)");
            entity.Property(e => e.Allapot).HasDefaultValueSql("'NULL'");
            entity.Property(e => e.Ar).HasColumnType("int(11)");
            entity.Property(e => e.EpitesVege)
                .HasDefaultValueSql("'NULL'")
                .HasColumnType("int(11)");
            entity.Property(e => e.KepUrl).HasDefaultValueSql("'NULL'");
            entity.Property(e => e.SzobakSzama).HasColumnType("int(11)");
            entity.Property(e => e.TelekMerete).HasDefaultValueSql("'NULL'");
            entity.Property(e => e.Tipus).HasDefaultValueSql("'NULL'");

            entity.HasOne(d => d.User).WithMany(p => p.Ingatlanoks)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("ingatlanoks_ibfk_1");
        });
